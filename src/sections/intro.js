...
const Intro = () => {
  ...
  return (
    ...
    <div className="intro">
      ...
      <a href="https://drive.google.com/file/d/1e1gHAOh3XpgjsvrEWalCZBwFcRlxE30B/view?usp=sharing" target="_blank" rel="noreferrer"><button className="btn btn-primary resume-btn">My Resume</button></a>
    </div>
    </section>
  );
};
